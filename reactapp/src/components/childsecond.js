  ...
  <a href="/property" id="property">Property Insurance</a>
     ...
     <div style={{backgroundColor:"rgb(210, 195, 174)",padding:"20px",height:"840px",marginTop:'0%'}}>
      ...
      >
        ...
        <img src="https://cdn-icons-png.flaticon.com/128/939/939085.png" alt="Avatar" style={{ width: '90px',   borderRadius: '50%' }} />
        </div>
      ...
      >
        ...
        <div style={{display:'flex'}}>
          <div style={{marginLeft:'0px'}}>
        <img src="https://cdn-icons-png.flaticon.com/128/1576/1576447.png" alt="Avatar" style={{ width: '90px',   borderRadius: '50%' }} />
        </div>
        <div style={{marginLeft:'10%'}}>
      ...
      >
        ...
        <div style={{display:'flex'}}>
          <div style={{marginLeft:'0px'}}>
        <img src="https://cdn-icons-png.flaticon.com/128/4161/4161636.png" alt="Avatar" style={{ width: '90px',   borderRadius: '50%' }} />
        </div>
        <div style={{marginLeft:'10%'}}>

...
const Life = () => {
  ...
  <div className="split left">
    <div className="centered">
      <img style={{height:"300px",width:"300px",marginRight:"150px",marginBottom:"20px",marginTop:"200px"}} src="https://res.cloudinary.com/dtrytsho8/image/upload/v1689178871/round-background-smiling-family_23-2147618990_1_wm2ocz.avif" alt="Avatar woman" />
...
<br></br>
  ...
  <div className="split right">
    <div className="centered">
        <p style={{color:'antiquewhite',fontFamily:"sans-serif",fontWeight:"bolder",fontSize:"20px"}}>Rs.1 Crore life cover starting at Rs.450/per month</p>
...
<div class="form-group">
    ...
    <label for="policyType" class="form-label">Policy Type:</label>
        ...
        <div class="form-group">
        <label for="authorityDocs" class="form-label">Upload Authority Documents:</label>

...
const Child = () => {
  ...
  <div className="split left">
    <div className="centered">
      <img style={{height:"300px",width:"300px",marginRight:"150px",marginBottom:"20px",marginTop:"200px"}} src="https://cdn-icons-png.flaticon.com/128/1702/1702342.png" alt="Avatar woman" />
...
<div class="form-group">
    ...
    <label for="policyType" class="form-label">Policy Type:</label>
        ...
        <div class="form-group">
        <label for="authorityDocs" class="form-label">Upload Birth Certificates:</label>

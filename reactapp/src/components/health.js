...
const Health=()=>
{
  ...
  <div className="split left">
    <div className="centered">
      <img style={{height:"300px",width:"300px",marginRight:"150px",marginBottom:"20px",marginTop:"200px"}} src="https://res.cloudinary.com/dtrytsho8/image/upload/v1689307325/health-insurance__1_-removebg-preview_x6zkyy.png" alt="Avatar woman" />
...
<div class="form-group">
    ...
    <label for="policyType" class="form-label">Policy Type:</label>
        ...
        <div class="form-group">
        <label for="authorityDocs" class="form-label">Upload Health Documents:</label>

  ...
  <a href="/property" id="property">Property Insurance</a>
     ...
     <div style={{backgroundColor:"rgb(210, 195, 174)",padding:"20px",height:"840px",marginTop:'0%'}}>
      ...
      >
        ...
        <img src="https://cdn-icons-png.flaticon.com/128/913/913439.png" alt="Avatar" style={{ width: '90px',   borderRadius: '50%' }} />
        </div>
        <div style={{marginLeft:'10%'}}>
        <p><span style={{ fontSize: '20px', marginRight: '15px',color:"goldenrod" }}>KOTAK HOME INSURANCE</span>  </p>
      ...
      >
        ...
        <div style={{display:'flex'}}>
          <div style={{marginLeft:'0px'}}>
        <img src="https://cdn-icons-png.flaticon.com/128/4270/4270381.png" alt="Avatar" style={{ width: '90px',   borderRadius: '50%' }} />
        </div>
        <div style={{marginLeft:'10%'}}>
      ...
      >
        ...
        <div style={{display:'flex'}}>
          <div style={{marginLeft:'0px'}}>
        <img src="https://cdn-icons-png.flaticon.com/128/1875/1875821.png" alt="Avatar" style={{ width: '90px',   borderRadius: '50%' }} />
        </div>
        <div style={{marginLeft:'10%'}}>
